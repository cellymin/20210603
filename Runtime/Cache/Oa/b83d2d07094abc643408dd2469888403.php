...
<form action="/index.php/oa/returnvisit/returnvisit_list" method="post" id="contact-form">
<div class="col-sm-12">
    <div class="ibox float-e-margins" id="shoujisf1">
        <div class="ibox-title">
            <h5><a class="collapse-link">回访记录 筛查选项</a></h5>
        ...
        <div class="ibox-content" style="padding-left:0px;padding-right:0px;" id="shoujisf3">
              ...
              <div class="row" style="margin:0;">
                ...
                <div class="col-sm-3" style="padding:0px;">
                            <div class="form-group">
                                        <label class="col-sm-12 control-label">回访时间</label>
                                        <div class="col-md-6">
...
<div class="col-sm-12">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5><a class="collapse-link">回访记录</a></h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-wrench"></i>
                </a>
        ...
        <div class="ibox-content" style="margin-bottom:0px; padding-bottom:0px;">
         ...
         <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>     
            <td><?php echo ($vo["hf_time"]); ?></td>
            <td class="hidden-xs"><?php echo ($vo["hfuserID"]); ?></td>
			...
			<td><?php echo ($vo["hf_zhuti"]); ?></td>
			<td><?php echo ($vo["hf_content"]); ?></td>
