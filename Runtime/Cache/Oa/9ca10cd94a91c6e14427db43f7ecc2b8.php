...
<form action="/index.php/oa/tongji/report_fangshi" method="post" id="contact-form">
<div class="col-sm-12">
    <div class="ibox float-e-margins" id="shoujisf1">
        ...
        <div class="ibox-content" style="padding-left:0px;padding-right:0px;" id="shoujisf3">
                ...
                <div class="col-sm-3" style="padding-left:0px;padding-right:0px;">
                    ...
                    <input name="zx_timeStart" type="text" value="<?php echo ($zx_timeStart); ?>" class="form-control layer-date" placeholder="YYYY-MM-DD" id="shijian1"/>
                    <span class="input-group-addon" id="visible-xs">开始时间</span>
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="input-group m-b" style="width:100%;">
                    <input name="zx_timeEnd" type="text"  value="<?php echo ($zx_timeEnd); ?>" class="form-control layer-date" placeholder="YYYY-MM-DD" id="shijian2"/>
...
<div class="col-sm-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
         ...
         <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["zxfs_level"] == 1): ?><tr>
           <td><div style="display:none"><?php echo ($num++); ?></div><a href="javascript:yiji('a<?php echo ($num); ?>');" class="a<?php echo ($num); ?>" title="+"><i class='icon icon-plus'></i>&nbsp;</a><?php echo ($vo["zxfs_name"]); ?></td>
         <?php else: ?>
           <tr id="a<?php echo ($num); ?>" style="display:none">
           <td><?php echo ($vo["zxfs_name"]); ?></td><?php endif; ?>   
           <td><?php echo ($vo["zixun"]); ?></td>
           <td><?php echo ($vo["yuyue"]); ?></td>
           <td><?php echo ($vo["daozhen"]); ?></td>
           <td><?php echo ($vo["ydaozhen"]); ?></td>
...
<form method="POST" action="/index.php/oa/tongji/ExcleDC_fangshi">
...
option = {
    ...
    series : [
        ...
        },
		{
            ...
            data:[
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["zxfs_level"] == 1): ?>{value:<?php echo ($vo["zixun"]); ?>, name:'<?php echo ($vo["zxfs_name"]); ?>'},<?php endif; endforeach; endif; else: echo "" ;endif; ?>
            ]
        },
		{
            name:'预约占比',
            ...
            data:[
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["zxfs_level"] == 1): ?>{value:<?php echo ($vo["yuyue"]); ?>, name:'<?php echo ($vo["zxfs_name"]); ?>'},<?php endif; endforeach; endif; else: echo "" ;endif; ?>
            ]
        },
		{
            name:'到诊占比',
            ...
            data:[
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["zxfs_level"] == 1): ?>{value:<?php echo ($vo["daozhen"]); ?>, name:'<?php echo ($vo["zxfs_name"]); ?>'},<?php endif; endforeach; endif; else: echo "" ;endif; ?>
            ]
        }
    ]
};
