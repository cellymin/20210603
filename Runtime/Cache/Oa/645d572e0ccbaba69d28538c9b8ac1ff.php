...
<div class="col-sm-12">
 <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5><a class="collapse-link"><?php echo ($yiyuanname); ?> - 咨询方式</a></h5>
        ...
        <form method="post" action="/mbs/index.php/oa/system_site/yyzxfs_insert">
        <div class="ibox-content" style="padding-bottom:0px;">
              <table class="table table-striped table-hover">
                  ...
                  <tbody>
<?php echo (zxfs_down_x1($StartColumnID,$column_level,$yyid)); ?>  
                        <tr>
                            <td colspan="3">
