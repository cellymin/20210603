...
<div class="col-sm-12">
 <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5><a class="collapse-link"><?php echo ($yiyuanname); ?> - 信息来源</a></h5>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <td><div class="checkbox-inline b-label"><input type="checkbox" id="quanxuan" name="quanxuan[]" <?php echo ($vo["yy_ID"]); ?> value="<?php echo ($vo["ID"]); ?>"/></div></td>
