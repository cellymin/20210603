...
<form action="/mbs/index.php/oa/operationlog/updateyuyuetime" method="post" id="contact-form">
<div class="col-sm-12">
    <div class="ibox float-e-margins" id="shoujisf1">
        <div class="ibox-title">
            <h5><a class="collapse-link">患者预约时间修改记录</a></h5>
                ...
                <button class="btn btn-primary" type="submit" name="submit1" value="确定">确定筛选</button>
				 <div class="col-xs-6">
                  <div data-toggle="buttons" class="btn-group">
                      <label class="btn btn-sm btn-white <?php echo ($active_yuyue); ?>" id="option11">
                          <input type="radio" id="option1" name="shijianleixing" value="预约时间">预约时间</label>
                      <label class="btn btn-sm btn-white <?php echo ($active_xiugai); ?>" id="option22">
                          <input type="radio" id="option2" name="shijianleixing" value="修改时间" >修改时间</label>
                  </div>
                </div>
                </div>
