...
<form action="/index.php/oa/tongji/report_qudao" method="post" id="contact-form">
<div class="col-sm-12">
    <div class="ibox float-e-margins" id="shoujisf1">
        <div class="ibox-title">
            <h5><a class="collapse-link">咨询渠道数据 筛查选项</a></h5>
...
<form method="POST" action="/index.php/oa/tongji/ExcleDC_qudao">
...
option = {
    ...
    series : [
        ...
        },
		{
            ...
            data:[
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>{value:<?php echo ($vo["zixun"]); ?>, name:'<?php echo ($vo["xx_name"]); ?>'},<?php endforeach; endif; else: echo "" ;endif; ?>
            ]
        },
		{
            name:'预约占比',
            ...
            data:[
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>{value:<?php echo ($vo["yuyue"]); ?>, name:'<?php echo ($vo["xx_name"]); ?>'},<?php endforeach; endif; else: echo "" ;endif; ?>
            ]
        },
		{
            name:'到诊占比',
            ...
            data:[
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>{value:<?php echo ($vo["daozhen"]); ?>, name:'<?php echo ($vo["xx_name"]); ?>'},<?php endforeach; endif; else: echo "" ;endif; ?>
            ]
        }
    ]
};
